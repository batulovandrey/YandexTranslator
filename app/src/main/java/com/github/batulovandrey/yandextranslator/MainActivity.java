...
import static com.github.batulovandrey.yandextranslator.ApiClient.KEY;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getTranslation(String input) {
        ...
        TranslationService service = apiClient.getTranslationService();
        Call<TranslationBean> call = service.getTranslation(KEY, input, LANG, FORMAT, OPTIONS);
